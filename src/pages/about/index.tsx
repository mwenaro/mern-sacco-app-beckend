...
import { PageWrapper, WhoWeAre } from '../../components';
    ...
    <div className="bg-gray-200 p-6">
      ...
      <WhoWeAre />
        ...
        <div className="relative rounded-lg overflow-hidden">
            <img src="/assets/images/4.3/pic10.jpg" width={400} height ={300} alt="image1" className="w-full h-auto object-cover" />
        </div>
        <div className="relative rounded-lg overflow-hidden">
            <img src="/assets/images/4.3/pic18.jpg" width={400} height ={300} alt="image2" className="w-full h-auto object-cover" />
        </div>
      </div>
    </div>
    </PageWrapper>
